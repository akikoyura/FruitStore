            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h3 class="card-title text-center pb-3">Products</h3>
                                    ...
                                    <table id="zero_config" class="table table-hover table-bordered text-center">
                                        ...
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td class="align-middle">{{$product->product_color}}</td>
                                                <td class="align-middle">{{$product->price}}</td>
                                                <td class="align-middle">
                                                    @if (!empty($product->image))
                                                        <img
                                                            src="{{asset('images/backend_images/products/small/'.$product->image)}}"
                                                            class="img-thumbnail" width="100px" height="100px" alt="">
                                                    @endif
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <a href="{{url('/admin/add-attributes/'.$product->id)}}"
                                                       class="btn btn-info mr-2">Add</a>

                                                    <!-- Sweet Alert Section -->
                                                    <a rel1="delete-product" rel="{{$product->id}}" href="javascript:"
                                                            ...
                                                            <div class="modal-content ">
                                                                <div class="modal-header ">
                                                                    <h5 class="modal-title "
                                                                        id="exampleModalLabel">{{$product->product_name}}
                                                                        Full Details</h5>
